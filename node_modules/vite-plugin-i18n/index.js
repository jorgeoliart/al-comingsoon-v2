...
const getVueVersion = () => {
  ...
  if (fs.existsSync(packageFile)) {
    packages = require(packageFile);
  }
  // 获取当前vue版本，默认 2
  const vueVersion = packages.dependencies.vue || packages.devDependencies.vue;
  try {
  ...
  return {
    ...
    transform(file, filePath, opt) {
      ...
      if (
        ...
        file.indexOf(path.parse(options.localeFile).dir) < 0
      ) {
        //处理js文件
        result = replaceScriptContent(file);
